...
describe 'word count' do
  ...
  it 'works on simple strings [10 points]' do
    'Doo bee doo bee doo'.count_words.should == {'doo' => 3, 'bee' => 2}
  end
  it 'ignores punctuation [5 points]' do
    'A man, a plan, a canal -- Panama!'.count_words.should == {'man' => 1, 'plan' => 1, 'canal' => 1, 'a' => 3, 'panama' => 1}
  end
  it 'works on the empty string [10 points]' do
    ''.count_words.should == {}
  end
  it 'ignores leading whitespace [10 points]' do
    "  toucan".count_words.should == {'toucan' => 1 }
  end
  it 'ignores embedded whitespace [10 points]' do
    "four   four  \n four \t four!".count_words.should == {'four' => 4}
  end
end
